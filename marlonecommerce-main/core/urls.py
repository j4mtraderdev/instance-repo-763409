...
urlpatterns = [
    ...
    path("featuredProduct/", allFeaturedProduct, name="all-featured-product"),
    path("newArrivals/", allNewArrivals, name="new-Arrivals"),
    path("hotDeals/", hotDeals, name="hot-Deals"),
    path("popularProducts/", popularProduts, name="popular-Produts"),
    ...
    path("searchOnMobile/", searchOnMobileview, name="searchOnMobile"),
